;; ## added by OPAM user-setup for emacs / base ## 9d94b2a23fbb2153b61c381f4a86ae4d ## you can edit, but keep this line
...
;; ## added by OPAM user-setup for emacs / tuareg ## 60c8f239d70d1923276c2f6f2e5f4645 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/dbrumley/.opam/4.02.3/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## 15c5723fc5076715697f44cfd10068e8 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/dbrumley/.opam/4.02.3/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/dbrumley/.opam/4.02.3/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/dbrumley/.opam/4.02.3/bin/ocp-indent"))
