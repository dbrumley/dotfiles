...
** HotCRP
I use the HOTCRP mode from David Mazieres at Stanford, available at
[[http://www.scs.stanford.edu/~dm/hotcrp-mode/hotcrp-mode.el][http://www.scs.stanford.edu/~dm/hotcrp-mode/hotcrp-mode.el]]
...
documentation on autocomplete.   Finally, use =ipython= for our REPL.
